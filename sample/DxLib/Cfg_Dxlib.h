...
namespace Cfg {
	namespace
	{
		std::vector<std::pair<int, std::function<int()>> >  Input_from_cfg_pad_DxLib(int pad, std::string file) {
		...
		std::vector<std::pair<int, std::function<int()>> >  Input_from_cfg_key_DxLib(std::string file, std::function<int(int)> ck) {
